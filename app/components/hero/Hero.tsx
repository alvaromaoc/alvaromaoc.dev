    ...
    return (
        <div className="text-center">
            ...
            <blockquote className="text-2xl font-semibold italic text-center">
                ...
                <span
                    className="mx-2 before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-gradient-to-br before:from-accent before:to-accentSidecar relative inline-block">
